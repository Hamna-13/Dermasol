# Unknown/Normal (Healthy Skin)

_Source: Merck Manual – Structure and Function of the Skin_
...
The skin keeps vital chemicals and nutrients in the body while providing a barrier against dangerous substances from entering the body and provides a shield from the harmful effects of ultraviolet radiation emitted by the sun. In addition, skin color, texture, and folds (see Descriptions of Skin Marks, and Growths, and Color Changes ) help mark people as individuals. Anything that interferes with skin function or causes changes in appearance (see Effects of Aging on the Skin ) can have major consequences for physical and mental health.
